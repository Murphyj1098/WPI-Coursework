...
class top_block(gr.top_block):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self.zeromq_push_sink_0 = zeromq.push_sink(gr.sizeof_gr_complex, 1, 'tcp://127.0.0.1:7000', 100, False, -1)
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_gr_complex*1, '/home/jrmurphy/Desktop/sample.dat', True)
        ...
        self.connect((self.blocks_vector_to_stream_0, 0), (self.zeromq_push_sink_0, 0))
